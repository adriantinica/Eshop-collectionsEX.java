...
public class App {
    ...
    public static void main(String[] args) throws InputMismatchException, Cart.ValueOutOfRangeException {
        ...
        Item<Product> item1 = new Item<>( product1, 120);
        cart.addItem(item1);
            
        Item<Product> item2 = new Item<>(product2,80);
        cart.addItem(item2);

        //Item<Product> item3 = new Item<>(product3,100);
        //cart.addItem(item3);
        ...
        cart.decreaseItemQuantity(item2,79);
